...
public abstract class CollageViewTestHelper {
    ...
    private static void putSamplesInElement(
        ...
        if(placeElementsAtOrigin){
            ...
            rootVisualElement.addChild(new IconImage(10, 110, BitmapFactory.decodeResource(res, R.drawable.ic_noun_robot2)));         Bitmap bitmap = BitmapFactory.decodeResource(res, R.drawable.bluebutton);
            NinePatch patches = new NinePatch(bitmap, bitmap.getNinePatchChunk(), null);
